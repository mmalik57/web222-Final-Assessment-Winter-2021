...
function toggleLoading(isLoading) {
  ...
  if (isLoading) {
    ...
    icon.className = "fas fa-hourglass-half"; //change the icon to use the Font Awesome hourglass-half icon (see https://fontawesome.com/icons/hourglass-half?style=solid)
    box.innerText = "Loading..."; //change the text to “Loading…”
    button.disabled = true; //disable the button, so the user can’t click it again
  } else {
    //When isLoading is false:
    //button.disabled = false;
    icon.className = "fas fa-search"; //change the icon to use the Font Awesome search icon (see https://fontawesome.com/icons/search?style=solid)
    box.innerText = "Search"; //change the text to “Search”
    button.disabled = false; //re-enable the button, so the user can click it
  }
